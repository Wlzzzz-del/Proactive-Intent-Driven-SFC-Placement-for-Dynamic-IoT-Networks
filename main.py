...
from mcp_agent.MCP import NLU_MCP_Full
...
def run(config):
    ...
    # Set up MCP server to convert intent data into .yaml
    # Intent_data_path && output_yaml_path

    M = NLU_MCP_Full("../datasets/intent/nlu_half.md", "../settings/v_sim_setting/mcp_gen.yaml", config.gen.model_type,config.gen.gen_type)
    M.convert()
